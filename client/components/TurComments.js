...
export default class SanatoriumPage extends Component {
    ...
    componentWillReceiveProps(nextProps){
    	...
    	this.setState({ reviews : nextProps.reviews || [], commentStats: nextProps.commentStats && nextProps.commentStats[0] || [] })
    }
				...
				<div>
					<Row>
						<Col className='center'>
							<h2 style={{ color: '#55c901' }}>{ languageId === 0 ? 'Tur reviews' : 'Отзывы о туре' }</h2>
							<Divider />
						</Col>
					</Row>
					<Row>
